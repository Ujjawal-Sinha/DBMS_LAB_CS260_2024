...
-- Task 1. List the names of all left-handed batsmen from England. Order the results alphabetically.
SELECT player_name 
FROM player 
WHERE batting_hand = 'Left-hand bat' AND country_name = 'England' 
ORDER BY player_name;

-- Task 2. List the names and age (in years, should be integer) as on 2018-12-02 of all bowlers with skill “Legbreak googly” who are 28 or more in age. Order the result in decreasing order of their ages. Resolve ties alphabetically.
SELECT player_name, 
...
-- Task 3. List the match ids and toss winning team IDs where the toss winner of a match decided to bat first.
